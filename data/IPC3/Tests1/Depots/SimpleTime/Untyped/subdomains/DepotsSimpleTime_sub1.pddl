...
(:action lift
 ...
 :effect
	(and (not (on ?y ?z)) (clear ?z) (not (available ?x)) (not (clear ?y)) (lifting ?x ?y) (not (at ?y ?p))))
...
(:action drop
 ...
 :effect
	(and (on ?y ?z) (clear ?y) (not (clear ?z)) (at ?y ?p) (not (lifting ?x ?y)) (available ?x)))
...
(:action load
 ...
 :effect
	(and (available ?x) (in ?y ?z) (not (lifting ?x ?y))))
...
(:action unload
 ...
 :effect
	(and (lifting ?x ?y) (not (available ?x)) (not (in ?y ?z))))
